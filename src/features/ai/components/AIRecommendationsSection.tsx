      ...
      <AnimatePresence mode="wait">
        {error ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <GlassCard className="lg:col-span-2 p-8 h-64 animate-pulse bg-white/5 border-white/5" />
            <GlassCard className="p-8 h-64 animate-pulse bg-white/5 border-white/5" />
          </div>
        ) : latestAnalysis ? (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div className="lg:col-span-8 space-y-6">
              <GlassCard className="p-8 bg-linear-to-br from-primary/10 via-primary/5 to-transparent border-primary/20 relative overflow-hidden group">
                 ...
                 <div className="space-y-6 relative z-10">
                    <div className="flex justify-between items-start">
                       <div className="space-y-1">
                          <div className="flex items-center gap-2 text-primary">
                             ...
                             <span className="text-[10px] font-black uppercase tracking-widest">Личный коуч</span>
                          </div>
                          <h4 className="text-3xl font-display font-black italic uppercase tracking-tighter leading-none">
                             {latestAnalysis.verdict || "Вердикт тренера"}
                          </h4>
                       </div>
                       <div className={cn(
                    ...
                    <p className="text-xl leading-relaxed text-foreground/90 font-medium max-w-2xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                 <GlassCard className="p-6 space-y-4 border-white/5">
                    ...
                    <ul className="space-y-3">
                       {(latestAnalysis.insights || []).map((insight, i) => (
                 ...
                 <GlassCard className="p-6 space-y-4 border-white/5">
                    ...
                    <ul className="space-y-3">
                       {(latestAnalysis.nextSteps || []).map((step, i) => (
            ...
            <div className="lg:col-span-4 space-y-4 h-full">
               <h5 className="text-[10px] font-black uppercase tracking-widest text-muted-foreground px-2">Конкретные рекомендации</h5>
